...
to create a simple and modular design.
...
The metric for this price will be based on lower end beer brewing machines since there currently are no mead brewing machines on the market.
