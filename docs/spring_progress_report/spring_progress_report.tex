...
\lstinputlisting[firstline=328,lastline=365,caption={The emoji radio button in XML.}]{code/content\_survey.xml}
Then I set the text of the radio buttons to the unicode values of three emojiis: happy, neutral, and sad.
\lstinputlisting[firstline=16,lastline=18,caption={The unicode values for the emojiis..}]{code/strings.xml}
...
\lstinputlisting[firstline=1,lastline=5,caption={The color theme used for the emojiis.}]{code/radioselector.xml}
