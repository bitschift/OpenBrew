...
\begin{ganttchart}[
  ...
  \ganttbar[progress=00, name=rdoc]{Requirements Document}{2016-10-28}{2016-11-04} \\
  \ganttlinkedbar[progress=00, name=srve]{Survey Potential Users and Customers}{2016-11-04}{2016-11-19} \\
  \ganttlinkedbar[progress=00, name=leanc]{Develop Lean Canvas Model}{2016-11-20}{2016-11-27} \\
  \ganttlinkedbar[progress=00, name=aiml]{Research AI, ML, RL structures}{2016-11-04}{2016-11-24} \\
  \ganttgroup{Construct Prototype}{2016-11-04}{2016-12-19} \\
    \ganttbar[progress=00, name=oeclone]{Hardware}{2016-11-04}{2016-11-05} \\
    \ganttbar[progress=00, name=rnagrow]{Electronics}{2016-11-05}{2016-11-10} \\
    \ganttlinkedbar[progress=00, name=rnaprep]{Gather Data}{2016-11-10}{2016-12-05} \\
    \ganttbar[progress=00, name=rnadev]{Construct Control Policy}{2016-12-05}{2016-12-19} \\
    \ganttbar[progress=00, name=rnaanal]{Gather More Data}{2016-12-19}{2017-01-19} \\
  ...
  \ganttgroup{Second Prototype Iteration}{2017-01-19}{2017-03-04} \\
    \ganttbar[progress=00, name=chipgrow]{Assemble Hardware}{2017-01-20}{2017-01-21} \\
    \ganttlinkedbar[progress=00, name=chipprep]{Electronics}{2017-01-21}{2017-01-26} \\
    \ganttbar[progress=00, name=chipdev]{Gather Data}{2017-01-26}{2017-02-19} \\
    \ganttbar[progress=00, name=chipanal]{Rework Control Policy}{2017-02-19}{2017-03-14} \\
