...
This method does put a larger load on the Raspberry Pi than the Android method, and it is difficult to set up.
...
\section{Data Generation and Flow}
...
This coordination issue poses a much more complex problem 
...
\section{Interface Between Front End and Device}
